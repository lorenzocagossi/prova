...
class Game():
  def __init__(self, starting_level_index = 0, levels = 5):
    #pygame.init()
  ...
  def collide(self, entity):
    ...
    if self_class == "Player":
      if entity_class == "Monster":
        ...
        for i in range(120):
          pygame.draw.rect(self.world.game.screen, (0,0,0), (0,0,640, 480))
        self.world.game.win()
...
class Wall(Entity):
  def __init__(self, x, y, world):
    super().__init__(x, y, world, "#", choice([(3, 0),(4,0)]))

class Single_Wall(Entity):
  def __init__(self, x,y, world):
    super().__init__(x, y, world, "x", (1,2))
