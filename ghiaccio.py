...
class Game():
  def __init__(self, starting_level_index = 0, levels = 4):
    #pygame.init()
    self.screen = pygame.display.set_mode(SCREEN_SIZE, 0)
    pygame.display.set_caption("IceWorld")
...
class World():
  def __init__(self, level_name, game):
    ...
    f = open("./levels/{}.txt".format(level_name))
    rows = f.readlines()
    f.close()
    ...
    if self.type == "G":
      bg_tileset = [(4,2), (4,2)]
      layer1_tileset = [(4,2), (3, 2)]
    elif self.type == "L":
      bg_tileset = [(4,2), (4,2)]
      layer1_tileset = [(3,2), (3,2),(3,2), (3,2),(3,2), (3,2),(3,2), (3,2),(3,2), (3,2),(3,2), (3,2),(3,2), (3,2),(3,2), (3,2), (2, 2)]
    ...
    for y in range(len(rows)):
      ...
      for x in range(len(r)):
        ...
        if char == "#":
          ...
          self.entities.append(Single_Wall(x,y, self))
...
class Single_Wall(Entity):
  def __init__(self, x,y, world):
    super().__init__(x, y, world, "x", (3,3))

class Monster(Entity):
  def __init__(self, x, y, world):
    #Entity.__init__(self, x, y, "M")
    super().__init__(x, y, world, ">", choice([(2,3),(0,2)]))
